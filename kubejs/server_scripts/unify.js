...
// ==================== MATERIAL UNIFICATION SYSTEM ====================
// This file unifies materials from different mods using Forge tags
// This allows cross-mod compatibility for materials that exist in multiple mods

// Aluminum Ingot Unification
// Combines: create_tank_defenses:aluminum_ingot, tfmg:aluminum_ingot
...
// Combines: create_tank_defenses:aluminum_dust, crusty_chunks:aluminum_dust
ServerEvents.tags('item', e => {
...
// Combines: create_tank_defenses:aluminum_sheet, vintageimprovements:aluminum_sheet
ServerEvents.tags('item', e => {
...
// Aluminum Block Unification
// Combines: create_tank_defenses:aluminum_block, crusty_chunks:aluminum_block, tfmg:aluminum_block
ServerEvents.tags('item', e => {
...
// Combines: create:copper_sheet, crusty_chunks:copper_plate
ServerEvents.tags('item', e => {
...
// Combines: create_tank_defenses:titanium_ingot, create_the_air_wars:titaniumingot
ServerEvents.tags('item', e => {
...
// Combines: create_tank_defenses:titanium_sheet, create_the_air_wars:titaniumsheet
ServerEvents.tags('item', e => {
...
// Combines: tfmg:lithium_ingot, crusty_chunks:lithium_ingot
ServerEvents.tags('item', e => {
...
// Lithium Raw Material Unification
// Combines: tfmg:raw_lithium, crusty_chunks:raw_lithium
ServerEvents.tags('item', e => {
...
// Combines: tfmg:lithium_block, crusty_chunks:lithium_block
ServerEvents.tags('item', e => {
...
// Combines: tfmg:dust_lithium, crusty_chunks:lithium_dust
ServerEvents.tags('item', e => {
...
// Combines: create_tank_defenses:steel_sheet, crusty_chunks:steelplate, tfmg:heavy_plate
ServerEvents.tags('item', e => {
...
// Combines: create_tank_defenses:steel_block, mekanism:block_steel, crusty_chunks:steel_block
ServerEvents.tags('item', e => {
...
// Sulfur and Sulfuric Acid Unification
// Raw Sulfur: create_the_air_wars:raw_sulfur, crusty_chunks:sulfur, vintageimprovements:sulfur
// Sulfur Blocks: vintageimprovements:sulfur_block, tfmg:sulfur, crusty_chunks:sulfur_block
// Sulfuric Acid: vintageimprovements:sulfuric_acid, tfmg:sulfuric_acid, mekanism:sulfuric_acid
ServerEvents.tags('item', e => {
...
// Uranium Unification
// Ingots: mekanism:ingot_uranium, crusty_chunks:uranium_neural_ingot
// Dusts: mekanism:dust_uranium, crusty_chunks:uranium_neutral_dust
ServerEvents.tags('item', e => {
...
// Hydrogen Fluid Unification
// Combines: mekanism:hydrogen, createbb:hydrogen
...
// Combines: create:brass_sheet, crusty_chunks:brass_plate
ServerEvents.tags('item', e => {
...
// Combines: createdeco:andesite_sheet, vintageimprovements:andesite_plate
ServerEvents.tags('item', e => {
